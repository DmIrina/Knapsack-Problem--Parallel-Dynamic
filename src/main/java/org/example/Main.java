...
public class Main {
    public static void main(String[] args) {
        ...
        Dynamic dynamic;
        itemsWarehouse = new ItemsWarehouse("d:\\items-1000000-200-20000.dat");
        dynamic = new Dynamic(itemsWarehouse, capacity);
        dynamic.pack();
        ParallelDynamic parallelDynamic = new ParallelDynamic(itemsWarehouse, capacity, 1);
        parallelDynamic.pack();
        parallelDynamic = new ParallelDynamic(itemsWarehouse, capacity, 2);
        parallelDynamic.pack();
        parallelDynamic = new ParallelDynamic(itemsWarehouse, capacity, 3);
        parallelDynamic.pack();
